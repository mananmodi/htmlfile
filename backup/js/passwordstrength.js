...
(function(IW, jQuery) {
    ...
    function updatePassword() {
        ...
        var
                ...
                progressBar =jQuery(".showpasswordmeter").find(".passwordStrengthBar div");
    ...
    jQuery.fn.passwordValidate = function() {
		...
		jQuery(".showpasswordmeter").append("<div class='passwordStrengthBar'><label class='lblStrength'>Strength:</label>" +
                "<div></div>" +
                "</div>");				
...
jQuery("input.password[type='password']").passwordValidate();